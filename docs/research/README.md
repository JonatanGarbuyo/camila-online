...
- [`payments.md`](payments.md) — pagos, comisiones y costo efectivo por venta.
- [`shipping-insurance.md`](shipping-insurance.md) — envíos nacionales, seguro y restricciones logísticas.
- [`social-whatsapp.md`](social-whatsapp.md) — WhatsApp Business, Meta y canales sociales.
- [`measurement.md`](measurement.md) — UTMs, GA4, Pixel/CAPI, KPIs y observabilidad de negocio.
